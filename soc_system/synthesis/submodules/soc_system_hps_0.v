...
module soc_system_hps_0 #(
		...
		output wire         spis1_txd,                //               spis1.txd
		input  wire         spis1_rxd,                //                    .rxd
		input  wire         spis1_ss_in_n,            //                    .ss_in_n
		output wire         spis1_ssi_oe_n,           //                    .ssi_oe_n
		input  wire         spis1_sclk_in,            //       spis1_sclk_in.clk
	...
	soc_system_hps_0_fpga_interfaces fpga_interfaces (
		...
		.spis1_txd                (spis1_txd),                //               spis1.txd
		.spis1_rxd                (spis1_rxd),                //                    .rxd
		.spis1_ss_in_n            (spis1_ss_in_n),            //                    .ss_in_n
		.spis1_ssi_oe_n           (spis1_ssi_oe_n),           //                    .ssi_oe_n
		.spis1_sclk_in            (spis1_sclk_in),            //       spis1_sclk_in.clk
