...
# Fri Jul 05 22:06:28 ICT 2019
# DO NOT MODIFY


# 
# SPI_Master "SPI Opencore" v18.1
# GIrving 2019.07.05.22:06:28
...
add_fileset_file spi_clgen.v VERILOG PATH spi_clgen.v
add_fileset_file spi_defines.v VERILOG PATH spi_defines.v
add_fileset_file spi_shift.v VERILOG PATH spi_shift.v
add_fileset_file spi_top.v VERILOG PATH spi_top.v TOP_LEVEL_FILE
...
add_fileset_file spi_defines.v VERILOG PATH spi_defines.v
add_fileset_file spi_shift.v VERILOG PATH spi_shift.v
add_fileset_file spi_top.v VERILOG PATH spi_top.v
add_fileset_file timescale.v VERILOG PATH timescale.v
...
add_interface_port conduit_export ss_pad_o ss Output 8
add_interface_port conduit_export sclk_pad_o sclk Output 1
add_interface_port conduit_export mosi_pad_o mosi Output 1
add_interface_port conduit_export miso_pad_i miso Input 1
...
set_interface_property interrupt associatedReset clock_reset
