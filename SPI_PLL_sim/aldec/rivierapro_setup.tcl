...
# ACDS 18.1 625 win32 2020.03.11.16:25:47
# ----------------------------------------
...
# ----------------------------------------
# If SPI_PLL is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/SPI_PLL.vo"
}
