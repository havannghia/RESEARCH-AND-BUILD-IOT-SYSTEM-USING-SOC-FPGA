...
# ACDS 18.1 625 win32 2020.02.18.10:54:07
# ----------------------------------------
...
# ----------------------------------------
# If SSP_UART_PLL is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "SSP_UART_PLL"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/SSP_UART_PLL.vo"
}
